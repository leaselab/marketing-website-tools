...
var fuelTypes = {
    ...
    3: {'type': 'Electric', 'centsPerLitre': 0},
    4: {'type': 'PHEV', 'centsPerLitre': 100}
};
...
$(function(){
    ...
    function calculateResults() {
        ...
        if ( allowCalculation ) {
            ...
            var interestRatePercentage = parseFloat(7.5/100);
            ...
            var medicareLevyThreshold = 24276;
            ...
            var weeklyCostForCalculator = weeklyCost - (weeklyCost * 0.25);
            weeklyCostForCalculator = round(weeklyCostForCalculator, 0);
